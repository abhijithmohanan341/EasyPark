...
<title>ParkingSlot::HomePage</title>
</head>
<body>
<h2>Welcome <?php echo $_SESSION["uname"]?></h2>
<br>
<a href="Myfile.php">My profile</a><br>
<a href="EditProfile.php">Edit Profile</a><br>
<a href="ChangePassword.php">Change Password</a><br>
<a href="ViewPlot.php">View Plot</a><br>
<a href="MyBooking.php">My Booking</a><br>
<a href="Complaint.php">Complaint Register</a><br>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EasyPark-User HomePage</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="MyFile.php" class="nav-item nav-link">Profile</a>
                           <a href="ViewPlot.php" class="nav-item nav-link">View Plot</a>
                    ...
                    <a href="../Index.php" class="btn btn-primary rounded-pill py-2 px-4 ms-lg-4">Logout</a>
                </div>
            </nav>
                ...
                <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="../Assest/Templates/Main/img/home3.jpg" class="img-fluid" alt="Image">
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Welcome <?php echo $_SESSION["uname"]?> !</h4>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="ViewPlot.php">Discover Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <img src="../Assest/Templates/Main/img/home1.jpg" class="img-fluid" alt="Image">
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(./Assest/Templates/Main/img/about-img-1.png);">
                        ...
                        <p class="mb-4">Finding a parking spot shouldn’t feel like a challenge. EasyPark is your smart parking companion, designed to help you quickly locate, reserve, and manage parking spaces with ease. With live updates and a user-friendly design, our platform eliminates the hassle of circling crowded streets and ensures your space is ready when you need it. From quick errands to long commutes, EasyPark makes every trip more convenient and stress-free.
                        <p class="mb-4">At EasyPark, we believe smarter parking means smarter cities. By reducing the time spent searching for spots, we help cut down on traffic jams, save fuel, and support greener urban living. Scalable for both individuals and organizations, our solution is built to adapt to modern lifestyles—bringing efficiency, reliability, and sustainability to everyday travel.
With a simple interface and real-time availability updates, we bring convenience to drivers, reduce congestion, and save valuable time. Whether it’s for daily commuting, shopping, or special events, EasyPark ensures your spot is reserved before you arrive.</p>
                        <h2><p>🚗 Why Choose EasyPark?</p></h2><br>
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                                    ...
                                    <div class="service-icon p-4">
                                        <h1><i class="fa fa-user-circle me-2"></i><h1>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    <div class="service-icon p-4">
                                        <h1><i class="fa fa-user-cog me-2"></i><h1>
                                    </div>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href=""><i class="fas fa-envelope me-2"></i> support@easypark.com</a>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-end mb-md-0">
                        <i class="fas fa-copyright me-2"></i><a class="text-white" href="HomePage.php"><b>EasyPark</b></a> , All right reserved.
                    </div>
