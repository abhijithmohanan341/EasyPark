...
if (isset($_POST["btn_pay"])) {   
    ...
    if ($Con->query($updateBookingStatusQuery)) {
        ...
        // $selectUserDetailsQuery = "SELECT * FROM tbl_booking b INNER JOIN tbl_user u ON b.user_id = u.user_id WHERE b.booking_id = '" . $booking_id . "'";
        // $userResult = $Con->query($selectUserDetailsQuery);
        // $userData = $userResult->fetch_assoc();

        // $userEmail = $userData['user_email'];
        // $userName = $userData['user_name'];

        // $productListHTML = "<table border='1' cellpadding='5' style='border-collapse: collapse;'>
        //                         <tr>
        //                             <th>Product</th>
        //                             <th>Qty</th>
        //                             <th>Price</th>
        ...
        // $selectCartItemsQuery = "SELECT * FROM tbl_cart c INNER JOIN tbl_product p ON c.product_id = p.product_id WHERE c.booking_id = '" . $booking_id . "'";
        // $cartItemsResult = $Con->query($selectCartItemsQuery);
        ...
        // $emailSubject = "Order Confirmation - #" . $booking_id;
        // $emailBody = "Hello " . $userName . ",<br><br>
        //               Thank you for your order! Your payment has been successfully processed. 
        //               Here are your order details:<br><br>" . $productListHTML .
        //               "<br><strong>Total Amount: " . $bookingAmount . " ₹</strong><br><br>
        //               We will notify you again once your order is shipped.<br><br>
        //               Thank you,<br>
        //               Your Company Name";
    ...
    <form action="" method="post">
        <div class="payment-container">
            <div class="payment-illustration">
                <lottie-player src="https://lottie.host/09c62156-41b0-4467-8397-8d616cdaea31/UseJozIpnV.json" background="transparent" speed="1" style="width: 300px; height: 300px;" loop autoplay class="floating"></lottie-player>
            ...
            <div class="payment-form">
                <div class="payment-header">
                    ...
                    <p>Complete your service payment securely</p>
                </div>
